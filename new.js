...
public class pra5a extends Cic
{
	double r=2.0;
	void area()
	{
...
function f6a(params) {
    let copyText = `// In Package mathematics
    package mathematics;
...
function f8b(params) {
    ...
    try
    {
        File inF = new File("txtfile");
        File outF  = new File("txtfile");
